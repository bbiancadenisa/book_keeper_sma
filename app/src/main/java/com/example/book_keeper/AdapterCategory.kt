...
import com.example.book_keeper.databinding.CategoryRowBinding
...
class AdapterCategory : RecyclerView.Adapter<AdapterCategory.HolderCategory>, Filterable {
    ...
    private fun deleteCategory(model: ModelCategory, holder: HolderCategory) {
        val id = model.id
            //use the id in order to delete itm
        ...
        ref.child(id).removeValue()
            .addOnSuccessListener {
                ...
                Toast.makeText(context, "Category could not be deleted", Toast.LENGTH_SHORT).show()
            }

    }

    inner class HolderCategory(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var categoryTv: TextView = binding.categoryId
